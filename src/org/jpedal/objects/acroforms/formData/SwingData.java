...
//                }
    ...
    public void displayComponent(int currentComp, FormObject formObject, Object comp, int startPage, int page) {
        ...
        if (SwingUtilities.isEventDispatchThread()) {
            ...
            scaleComponent(formObject.getPageNumber(), displayScaling, rotation, currentComp, (Component)comp, true,false, indent);
            ...
            final Runnable doPaintComponent = new Runnable() {
                public void run() {
                    scaleComponent(pageID, displayScaling, rotation, id, comp1, true,false, indent);
                }
            };
            SwingUtilities.invokeLater(doPaintComponent);
        }
    ...
    public int getFieldType(Object comp) {
        ...
        }else if(comp instanceof JTextField || comp instanceof JTextArea || comp instanceof JPasswordField){
            return TEXT_TYPE;
        }else if(comp instanceof JRadioButton || comp instanceof JCheckBox || comp instanceof JButton){
            return BUTTON_TYPE;
        }else if(comp instanceof JList || comp instanceof JComboBox){
            return LIST_TYPE;
        }else {
            return UNKNOWN_TYPE;
        }
