...
public class XFAStreamDecoder extends PdfStreamDecoder {
    ...
    public final T3Size decodePageContent(PdfObject pdfObject) throws PdfException {
        ...
        Node root=formRenderer.getXFA(PdfDictionary.XFA_TEMPLATE);

        /**
         * for the moment just print out content
         */
        parseNode(root, new ArrayList(),0);

        return null;
    }

    private static void parseNode(Node nodeToParse, ArrayList nodeList,int indent) {
