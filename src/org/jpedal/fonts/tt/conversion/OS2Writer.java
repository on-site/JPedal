...
public class OS2Writer extends OS2 implements FontTableWriter{
    ...
    public byte[] writeTable() throws IOException {
        ...
        if(originalFont.getFontType()==StandardFonts.TRUETYPE) {     	
			...
			Hhea hhea = (Hhea) glyphs.getTable(FontFile2.HHEA);	    	
			int ascender = hhea.getIntValue(Hhea.ASCENDER);
			int descender = hhea.getIntValue(Hhea.DESCENDER);
			
			bos.write(TTFontWriter.setNextInt16(3)); //USHORT	version	0x0004
			...
			bos.write(TTFontWriter.setNextInt16(5)); //USHORT	usWidthClass
			bos.write(TTFontWriter.setNextInt16(0)); //USHORT	fsType
			//ascender is multiplied by 0.3 to support average sub and superscirpt
			bos.write(TTFontWriter.setNextInt16((int)(ascender*0.3))); //SHORT	ySubscriptXSize
			bos.write(TTFontWriter.setNextInt16((int)(ascender*0.3))); //SHORT	ySubscriptYSize
			...
			//ascender is multiplied by 0.3 to support average sub and superscirpt
			bos.write(TTFontWriter.setNextInt16((int)(ascender*0.3))); //SHORT	ySuperscriptXSize
			bos.write(TTFontWriter.setNextInt16((int)(ascender*0.3))); //SHORT	ySuperscriptYSize
			...
			bos.write(TTFontWriter.setNextInt16((int)(ascender*0.3))); //SHORT	yStrikeoutSize
			bos.write(TTFontWriter.setNextInt16((int)(ascender*0.3))); //SHORT	yStrikeoutPosition
			...
			bos.write(TTFontWriter.setNextInt16(ascender+descender)); //SHORT	sTypoAscender
			bos.write(TTFontWriter.setNextInt16(0)); //SHORT	sTypoDescender
			bos.write(TTFontWriter.setNextInt16(0)); //SHORT	sTypoLineGap
			bos.write(TTFontWriter.setNextInt16(ascender)); //USHORT	usWinAscent
			descender = Math.abs(descender);
			bos.write(TTFontWriter.setNextInt16(descender)); //USHORT	usWinDescent
